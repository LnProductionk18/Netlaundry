...
<head>
	<meta charset="utf-8">
	<title>Page Status Pembayaran</title>
...
<div class="">
    <nav class="navbar navbar-light nb">
      <a class="navbar-brand" href="<?php echo site_url('admin/admin/indexstbyr');?>"><img class="img" src="<?php echo base_url();?>bootstrap/img/mesincuci.png">&nbsp;Netlaundry- Status Pembayaran</a>
...
<div class="container divjumbo1" style="color: white;">
	...
	<div class="container">
    <div class="show">
	<center><h3><b><h2><u>Page Status Pembayaran</u></h2></b></center>
	...
	<table class="table table-bordered table-striped" id="mydata">
		...
		<tbody>
			<?php
				$no=0;
				foreach($stbyr->result_array() as $i):
					$no++;
					$id_status_bayar=$i['id_status_bayar'];
					$des_bayar=$i['des_bayar'];
            ?>
			<tr>
				<td align="center"><?php echo $no;?></td>
				<td><?php echo $id_status_bayar;?></td>
				<td><?php echo $des_bayar;?></td>
                <td align="center"><a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal_edit<?php echo $id_status_bayar;?>"> 
				<span class="glyphicon glyphicon-edit"></span> Edit </a>&nbsp | &nbsp
				<a class="btn btn-sm btn-sm btn-danger" data-toggle="modal" data-target="#modal_hapus<?php echo $id_status_bayar;?>"> 
   ...
   <!-- <a style="color: black; border-radius: 50px; border-color: black; border-width: 2px;" class="btn btn-success" href="<?php echo base_url('index.php/perpus/export_excelbuku') ?>">
    ...
    <!-- ============ MODAL ADD status cucian =============== -->
        <div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/admin/admin/simpan_stbyr'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Status Pembeyaran</label>
                        <div class="col-xs-8">
                            <input name="id_status_bayar" class="form-control" type="text" placeholder="Kode..." required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="des_bayar" class="form-control" type="text" placeholder="Status..." required>
                        </div>
                    </div>
    ...
    <?php 
        ...
        $des_bayar=$i['des_bayar'];
    ?>
        <div class="modal fade" id="modal_edit<?php echo $id_status_bayar;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header" align="center">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/admin/admin/edit_stbyr'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kode Status Cucian</label>
                        <div class="col-xs-8">
                            <input name="id_status_bayar" value="<?php echo $id_status_bayar;?>" class="form-control" type="text" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="" value="<?php echo $des_bayar;?>" class="form-control" type="text" placeholder="Status Baru..." readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="des_bayar" value="<?php echo $des_bayar;?>" class="form-control" type="text" placeholder="Status Baru..." required>
                        </div>
                    </div>
    ...
    <!--END MODAL ADD status cucian-->
     ...
     <?php 
        ...
        $des_bayar=$i['des_bayar'];
    ?>
        <div class="modal fade" id="modal_hapus<?php echo $id_status_bayar;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header" align="center">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/admin/admin/hapus_stbyr'?>">
                <div class="modal-body">

                    <div class="form-group">
                        <div class="alert alert-warning" align="center"><h3>Apakah Anda yakin <br> ingin menghapus data???</h3></div>
                        <br>
                        <label class="control-label col-xs-3" >Kode Status Pembayaran</label>
                        <div class="col-xs-8">
                            <input name="id_status_bayar" value="<?php echo $id_status_bayar;?>" class="form-control" type="text" readonly>
                        </div>
                    </div>
